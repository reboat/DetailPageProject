        ...
        if (mData != null && mData.draftDetailBean != null && mData.draftDetailBean.getArticle() != null && !TextUtils.isEmpty(mData.draftDetailBean.getArticle().getUrl())) {
            if (position == 4) {
                new Analytics.AnalyticsBuilder(itemView.getContext(), "800005", "AppTabClick", false)
                        ...
                        .columnID(String.valueOf(mData.draftDetailBean.getArticle().getColumn_id()))
                        .columnName(mData.draftDetailBean.getArticle().getColumn_name())
                        .pageType("新闻详情页")
            ...
            OutSizeAnalyticsBean bean = OutSizeAnalyticsBean.getInstance()
                    ...
                    .setColumn_id(String.valueOf(mData.draftDetailBean.getArticle().getColumn_id()))
                    .setColumn_name(mData.draftDetailBean.getArticle().getColumn_name())
                    .setPageType("新闻详情页")
                    .setUrl(mData.draftDetailBean.getArticle().getUrl())
