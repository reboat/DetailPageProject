...
import com.zjrb.zjxw.detailproject.ui.nomaldetail.holder.NewsNoCommentTextHolder;
...
import com.zjrb.zjxw.detailproject.ui.nomaldetail.holder.NewsTextMoreHolder;
    ...
    public void onItemClick(View itemView, int position) {
        ...
        if (datas.get(position) instanceof RelatedSubjectsBean) {
            ...
            if (!TextUtils.isEmpty(detailBean.getArticle().getColumn_url())) {
                Nav.with(UIUtils.getContext()).to(detailBean.getArticle().getColumn_url());
            }
        }
    }
