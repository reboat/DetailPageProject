...
public class VideoGridSpaceDivider extends AbsSpaceDivider {
     ...
     */
    public VideoGridSpaceDivider(float spaceDip) {
     ...
     */
    public VideoGridSpaceDivider(float spaceDip, int colorOrColorId, boolean isColorId) {
     ...
     * @param isColorId      true:表示是colorId；false:表示是Color
     */
    public VideoGridSpaceDivider(float spaceDip, int colorOrColorId, boolean includeEdge,
                                 boolean isColorId) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State
        ...
        if (includeEdge) { // 包括边界
            ...
            outRect.left = Math.round(totalSpanSize * mSpace);
            // spacing - (column + 1) * ((1f /    spanCount) * spacing)
            outRect.right = Math.round(mSpace - (totalSpanSize + spanSize) * mSpace);
