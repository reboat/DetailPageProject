...
/**
 * 可放缩ImageView 已适配夜间模式
 *
 * @author a_liYa
 * @date 2016/12/16 上午10:22.
 */
public class PhotoView extends MaskImageView implements IPhotoView {
     ...
     * 启用长图模式
     */
    public void enableLongPictureMode() {
        this.isLongPictureMode = true;
        requestLayout();
    }
